...
/**
 * An effect that makes the player not receive  any victory points for the ventures he acquired during the game.
 */
public class NoVentureVictoryPointsEffect implements Effect{
